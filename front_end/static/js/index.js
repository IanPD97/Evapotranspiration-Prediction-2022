...
function change()
{
    let url = "http://127.0.0.1:4000/irrigate"
    fetch(url)
    var elem = document.getElementById("irrigate");
    if (elem.textContent=="Regar") elem.textContent = "Dejar de regar";
    else elem.textContent = "Regar";
};
